...
public static int ingresarNodoOrigen(String nodoOrige, String noExiste,int tope){
 ...
 jmapa.setIcon(new ImageIcon(scaledInstance));  
    ...
    private void initComponents() {
        ...
        jPanel1.add(jmapa);
        jmapa.setBounds(10, 10, 480, 380);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(210, 10, 510, 520);
        ...
        setSize(new java.awt.Dimension(774, 640));
    ...
    else  JOptionPane.showMessageDialog(null,"No Hay Vertices conectados ");
    
    }//GEN-LAST:event_jMenuItem9ActionPerformed

    private void jMenuItem10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem10ActionPerformed
      int Eliminar= ingresarNodoOrigen("Ingrese Vertice a Eliminar ","Vertice No existe",tope); 
...
jPanel1.setBackground(jButton8.getBackground());        // TODO add your handling code here:
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        if(tope<=1)
        JOptionPane.showMessageDialog(null,"Cree nuevo Vertice : ");
    ...
    private void jMenuItem13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem13ActionPerformed
        if(tope>=2){
            permanente =  ingresarNodoOrigen("Ingrese Vertice Origen","El vertice Origen No existe",tope);// hacemos el llamano de la funcion
            nodoFin =  ingresarNodoOrigen("Ingrese Vertice Fin","Vertice fin No existe",tope);
            Algoritmo_Dijkstra Dijkstra = new Algoritmo_Dijkstra(arboles,tope,permanente,nodoFin);
            Dijkstra.dijkstra();
            jtacumulado.setText(""+Dijkstra.getAcumulado());
        }
        else JOptionPane.showMessageDialog(null,"Se deben de crear mas Vertices  ");
